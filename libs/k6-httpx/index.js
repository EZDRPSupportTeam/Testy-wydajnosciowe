...
class Request {
  ...
  addHeader(name, value) {
    this.params.headers = Object.assign({}, this.params.headers, {
      [name]: value,
    });
    return this;
  }
...
class Httpx {
  constructor(opts = {}) {
    let _deconstructedParams = [
      "baseURL",
      "errorMetricCondition",
      "headers",
      "tags",
      "errorMetric",
    ];
  ...
  addHeader(name, value) {
    this.k6params.headers = Object.assign(this.k6params.headers, {
      [name]: value,
    });
  }
  ...
  _merge_params(params1, params2) {
    ...
    new_params.headers = Object.assign(
      {},
      params1.headers || {},
      params2.headers || {},
    );
  ...
  batch(array_of_requests, batch_shared_params) {
    ...
    array_of_requests.forEach((element) => {
      if (Array.isArray(element)) {
        ...
        let body = element[2];
        let request_params = this._merge_params(
          batch_shared_params,
          element[3],
        );
