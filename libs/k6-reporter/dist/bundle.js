              ...
              function (e, r, t) {
                ...
                function v(e, r) {
                  ...
                  if (
                    ((i.filename = (function (e, r) {
                      ...
                      if (o && o.length)
                        ((e = e.replace(/^\/*/, '')),
                          (i = Array.isArray(r.root) ? h(e, r.root) : t.resolveInclude(e, r.root || '/', !0)))
                      else if (
                        (r.filename && ((s = t.resolveInclude(e, r.filename)), n.existsSync(s) && (i = s)),
                        !i && Array.isArray(a) && (i = h(e, a)),
                    ...
                    var a = r.includer(e, i.filename)
                    if (a && (a.filename && (i.filename = a.filename), a.template)) return p(i, a.template)
                  }
                  return p(i)
                }
                ...
                function x(e, r) {
                  ...
                  ;((this.templateText = e),
                    ...
                    (this.source = ''),
                    (n.client = r.client || !1),
                    (n.escapeFunction = r.escape || r.escapeFunction || s.escapeXML),
                ...
                ;((t.cache = s.cache),
                  ...
                  (t.compile = function (e, r) {
                    return (
                      r &&
                        r.scope &&
                        (a || (console.warn('`scope` option is deprecated and will be removed in EJS 3'), (a = !0)),
                  ...
                  (t.render = function (e, r, t) {
                    var n = r || {},
                      i = t || {}
                    return (2 == arguments.length && s.shallowCopyFromList(i, n, d), p(i, e)(n))
                  }),
                  (t.renderFile = function () {
                    var e,
                      ...
                      a = { filename: i }
                    return (
                      'function' == typeof arguments[arguments.length - 1] && (e = n.pop()),
                      n.length
                        ? ((r = n.shift()),
                          n.length
                            ? s.shallowCopy(a, n.pop())
                            : (r.settings &&
                                (r.settings.views && (a.views = r.settings.views),
                                r.settings['view cache'] && (a.cache = !0),
                                (t = r.settings['view options']) && s.shallowCopy(a, t)),
                              s.shallowCopyFromList(a, r, l)),
                          (a.filename = i))
                        : (r = {}),
                      f(a, r, e)
                    )
                  ...
                  (x.modes = { EVAL: 'eval', ESCAPED: 'escaped', RAW: 'raw', COMMENT: 'comment', LITERAL: 'literal' }),
                  (x.prototype = {
                    createRegex: function () {
                      var e = '(<%%|%%>|<%=|<%-|<%_|<%#|<%|%>|-%>|_%>)',
                        r = s.escapeRegExpChars(this.opts.delimiter),
                        t = s.escapeRegExpChars(this.opts.openDelimiter),
                        n = s.escapeRegExpChars(this.opts.closeDelimiter)
                    ...
                    compile: function () {
                      var e,
                        ...
                        o = '',
                        c = n.escapeFunction,
                        d = n.filename ? JSON.stringify(n.filename) : 'undefined'
                      if (!this.source) {
                        if (
                          (this.generateSource(),
                          (a +=
                          ...
                          n.destructuredLocals && n.destructuredLocals.length)
                        ) {
                          for (
                            var l = '  var __locals = (' + n.localsName + ' || {}),\n', u = 0;
                            u < n.destructuredLocals.length;
                            u++
                          ) {
                            var h = n.destructuredLocals[u]
                            ;(u > 0 && (l += ',\n  '), (l += h + ' = __locals.' + h))
                          }
                          a += l + ';\n'
                        }
                      ...
                      ;((e = n.compileDebug
                        ...
                        n.client &&
                          ...
                          n.compileDebug && (e = 'rethrow = rethrow || ' + g.toString() + ';\n' + e)),
                      ...
                      var p = n.client
                        ...
                        : function (e) {
                            return r.apply(n.context, [
                              ...
                              c,
                              function (r, t) {
                                var i = s.shallowCopy({}, e)
                                return (t && (i = s.shallowCopy(i, t)), v(r, n)(i))
                              },
                              g,
                            ])
                          }
                      if (n.filename && 'function' == typeof Object.defineProperty) {
                        var f = n.filename,
                          m = i.basename(f, i.extname(f))
                        try {
                          Object.defineProperty(p, 'name', { value: m, writable: !1, enumerable: !1, configurable: !0 })
                        } catch (e) {}
                      }
                      return p
                    },
                          ...
                          if (this.mode) {
                            ...
                            switch (this.mode) {
                              case x.modes.EVAL:
                                ...
                                break
                              case x.modes.ESCAPED:
                                this.source += '    ; __append(escapeFn(' + b(e) + '))\n'
                                break
                              case x.modes.RAW:
                ...
                ;(function (e) {
                  ...
                  ;((t.resolve = function () {
                    ...
                    (t.relative = function (e, r) {
                      ...
                      for (
                        var i = n(e.split('/')), s = n(r.split('/')), a = Math.min(i.length, s.length), o = a, c = 0;
                        c < a;
                        c++
                      )
                        if (i[c] !== s[c]) {
                      ...
                      return (d = d.concat(s.slice(o))).join('/')
                    }),
                    (t.sep = '/'),
                    (t.delimiter = ':'),
                    (t.dirname = function (e) {
                      if (('string' != typeof e && (e += ''), 0 === e.length)) return '.'
                      for (var r = e.charCodeAt(0), t = 47 === r, n = -1, i = !0, s = e.length - 1; s >= 1; --s)
                    ...
                    (t.extname = function (e) {
                      'string' != typeof e && (e += '')
                      for (var r = -1, t = 0, n = -1, i = !0, s = 0, a = e.length - 1; a >= 0; --a) {
                        var o = e.charCodeAt(a)
                        if (47 !== o)
                          (-1 === n && ((i = !1), (n = a + 1)),
                            46 === o ? (-1 === r ? (r = a) : 1 !== s && (s = 1)) : -1 !== r && (s = -1))
                        else if (!i) {
                          t = a + 1
                          break
                        }
                      }
                      return -1 === r || -1 === n || 0 === s || (1 === s && r === n - 1 && r === t + 1)
                        ? ''
                        : e.slice(r, n)
                    }))
            ...
            5: [
              function (e, r, t) {
                ...
                var d,
                  ...
                  h = -1
                function p() {
                  u && d && ((u = !1), d.length ? (l = d.concat(l)) : (h = -1), l.length && f())
                }
                function f() {
                  if (!u) {
                    var e = c(p)
