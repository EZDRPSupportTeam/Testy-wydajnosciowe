...
const apiMetricWaitingTime9 = new Trend('ezdrp__pobierz_licznik_nowezadania');
...
export class _EzdRpApiDashboard extends EzdRpApi {
    ...
    wersja() {
        ...
        let reqData = null;
        let res = this.post('/wersja', reqData, params);
        return res;
    }
    ...
    pobierzMenu(param) {
        ...
        let reqData = null;
        let res = this.post('/ezdrp/administracja/menu/menu/pobierz', reqData, params);
    ...
    pobierzLicznikMenu() {
        let params = this.getParams();
        let reqData = null;
        let res = this.post(this.drid('/pobierz-licznik-menu'), reqData, params);
    ...
    pobierzLicznikNowychZadan() {
        let params = this.getParams();
        params.responseType = 'none';
        let reqParam = {};
        let reqData = reqParam ? this.toJson(reqParam) : null;
        let res = this.post('/ezdrp/nowe-zadania/licznik/pobierz', reqData, params);
