...
export class _EzdRpApiFiles extends EzdRpApi {
    ...
    directFileUploadToken(fileNameToUpload) {
        ...
        let reqData = this.toJson(reqDataRaw);
        let res = http.post(`${this.ezdRpClient.ezdRPConfig.getFileUrl()}/UploadToken/new-upload-token`, reqData, params);
        this.checkRes(res);
        return res;
    }
    directFileChangeTitle(fileId, fileName, fileToken) {
        ...
        params.headers['Content-Type'] = 'application/json';    
        let res = http.get(`${this.ezdRpClient.ezdRPConfig.getFileUrl()}/Download/TitleChange?idPlikStorage=${fileId}&name=${fileName}`, params);
        this.checkRes(res);
        return res;
    }
    directFileDelete(fileId, fileToken) {
        ...
        let reqData = this.toJson(reqDataRaw);
        let res = http.post(`${this.ezdRpClient.ezdRPConfig.getFileUrl()}/Download/delete/file`, reqData, params);
        this.checkRes(res);
        return res;
    }
    directFileGetDownloadToken(fileId) {
        ...
        params.headers['Accept-Encoding'] = 'gzip, deflate, br';
        params.headers['Content-Type'] = 'application/json';  
        let res = http.get(`${this.ezdRpClient.ezdRPConfig.getFileUrl()}/Token/gettoken/${fileId}`, params);
        this.checkRes(res);
        return res;
    }
    directDownloadFile(fileToken) {
        ...
        params.headers['ftoken'] = fileToken;
        params.responseType = 'none';
        let res = http.get(`${this.ezdRpClient.ezdRPConfig.getFileUrl()}/Download/file`, params);
        this.checkRes(res);
        return res;
    }
}