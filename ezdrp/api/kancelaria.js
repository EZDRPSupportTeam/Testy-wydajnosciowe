...
const apiMetricWaitingTime2 = new Trend(
  "ezdrp__pobierz_pisma_do_zarejestrowania_w_skladzie",
);
const apiMetricWaitingTime3 = new Trend(
  "ezdrp__korespondencja_wychodzaca_as_zarejestruj",
);
...
export class _EzdRpApiKancelaria extends EzdRpApi {
  ...
  pobierzPismaDoRejestracjiWSkladzie(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/pobierz-pismo-do-zarejestrowania-w-skladzie",
      reqData,
      params,
    );
  ...
  rejestrujKorespondencjeWychodzaca(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/korespondencja-wychodzaca-as-zarejestruj-korespondencje",
      reqData,
      params,
    );
  ...
  pobierzSzablonyWydrukowKW(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/ezdrp/korespondencja-wychodzaca/szablon-wydruku/pobierz-pelne",
      reqData,
      params,
    );
  ...
  otworzKarton(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/ezdrp/sklad-chronologiczny/karton/otworz-nowy",
      reqData,
      params,
    );
  ...
  zestawienieKorespondencjiWychodzacej(param) {
    ...
    let reqParam = {
      ...
      status: param.status,
      idOddzial: null,
      idKomorkaOrganizacyjna: null,
      idRodzajPrzesylki: null,
      dataRejestracjiZakres: param.dataWplywu,
    }; // param;
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/korespondencja-zestawienie-lista-korespondencji",
      reqData,
      params,
    );
  ...
  wczytanieKW(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/korespondencja-wychodzaca-as-przesylka-do-kancelarii",
      reqData,
      params,
    );
    apiMetricWaitingTime8.add(res.timings.waiting);
  ...
  pobierzCenyPrzesylki(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/korespondencja-wychodzaca-as-pobierz-ceny-dla-przesylki",
      reqData,
      params,
    );
    apiMetricWaitingTime8.add(res.timings.waiting);
  ...
  wyslijKoperte(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/korespondencja-wychodzaca-as-przygotuj-przesylke-do-wyslania",
      reqData,
      params,
    );
    apiMetricWaitingTime8.add(res.timings.waiting);
