...
export class _EzdRpApiNoweZadania extends EzdRpApi {
  pobierzDoObsluzenia(param) {
    ...
    let res = this.post(
      "/ezdrp/nowe-zadania/do-obsluzenia/lista-stronnicowana",
      reqData,
      params,
    );
    return res;
  ...
  pobierzMonitorowanie(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/ezdrp/nowe-zadania/monitoring/lista-stronnicowana",
      reqData,
      params,
    );
    return res;
  ...
  pobierzObieg(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/ezdrp/nowe-zadania/zadanie/szczegoly/obieg",
      reqData,
      params,
    );
    return res;
  ...
  szczegolyPrzestrzeni(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/ezdrp/nowe-zadania/zadanie/szczegoly",
      reqData,
      params,
    );
    return res;
  ...
  zmienNazweDokumentu(param) {
    ...
    let reqParam = param
      ? {
          idDokumentPrzestrzeni: param.idDokumentPrzestrzeni,
          nazwa: param.nazwa,
        }
      : null;
    let reqData = reqParam ? this.toJson(reqParam) : null;
  ...
  zmienNazweDokumentuRpw(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/ezdrp/dokumenty/dokumenty/zmien-nazwe-dokumentu-pisma",
      reqData,
      params,
    );
    return res;
  ...
  historiaPrzestrzeni(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/ezdrp/zdarzenia/obiekt/pobierz-liste",
      reqData,
      params,
    );
    return res;
  ...
  przyjmijZadanie(param) {
    ...
    let reqData = reqParam ? this.toJson(reqParam) : null;
    let res = this.post(
      "/ezdrp/nowe-zadania/zadanie/przyjmij",
      reqData,
      params,
    );
    return res;
