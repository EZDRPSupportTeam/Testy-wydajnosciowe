...
export class _EzdRpApiAdmin extends EzdRpApi {
  getSzablonyUprawnien() {
    ...
    let res = this.post(
      "/ezdrp/administracja/uprawnienia/szablony/lista-stronnicowana",
      reqData,
      params,
    );
  ...
  dodajSzablonUprawnien(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/administracja/uprawnienia/szablon/dodaj",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  getUprawnieniaStanowiska(param) {
    ...
    let reqDataRaw = {
      ...
      pageInfo: { pageNumber: 0, pageSize: 50 },
      sort: [],
    };
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/administracja/uzytkownicy/uprawnienia/szablony/lista-stronnicowana",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  dodajUprawnieniaStanowiska(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/administracja/uprawnienia/szablon/nadaj",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  getJrwaList() {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/jrwa/zarzadzanie/schematy/lista",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  pobierzDashboardAdministracja(param) {
    ...
    let reqData = null;
    let res = this.post(
      "/ezdrp/administracja/dashboard/dashboard/pobierz",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  pobierzKomunikatyAdministracja(param) {
    ...
    let reqData = null;
    let res = this.post(
      "/ezdrp/administracja/dashboard/komunikaty",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  pobierzKalendarzAdministracja(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/administracja/dashboard/kalendarz",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  pobierzOstatnioWybieraneStanowiska(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/administracja/stanowiska/ostatnio-wybierane",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  dodajKluczAPI(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/administracja/api/klucz/dodaj",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  pobierzKluczeAPI() {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/administracja/klucze-api/lista-stronicowana",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  pobierzSzablonyDokumentowFoldery(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/administracja/katalogi-szablonow/pobierz-administracja",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  dodajSzablonDokumentuFolder(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/administracja/katalogi-szablonow/dodaj",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  dodajDostepDoSzablonowDokumentow(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/administracja/dostepy-szablonow/ustaw",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  pobierz_pkn(param) {
    ...
    let res = this.post(
      "/ezdrp/korespondencja-wychodzaca/pkn/szablony/lista",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
  ...
  dodaj_pkn(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/korespondencja-wychodzaca/pkn/szablon/dodaj",
      reqData,
      params,
    );
    apiMetricWaitingTime.add(res.timings.waiting);
