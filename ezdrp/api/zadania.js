...
const apiMetricWaitingTime5 = new Trend(
  "ezdrp__akceptacja_dokumentow_as_dodaj_dokument_do_akceptacji_zaakceptuj",
);
...
const apiMetricWaitingTime8 = new Trend(
  "ezdrp__dokument_sprawdz_nowsza_wersje",
);
...
export class _EzdRpApiZadania extends EzdRpApi {
  ...
  akceptujZadanie(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/akceptacja-dokumentow-as-dodaj-dokument-do-akceptacji-zaakceptuj",
      reqData,
      params,
    );
  ...
  dokumentSprawdzCzyIstniejeNowszaWersja(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/dokument-sprawdz-czy-istnieje-nowsza-wersja",
      reqData,
      params,
    );
  ...
  pobierzZadaniaPowiazane(param) {
    ...
    let reqData = this.toJson(reqDataRaw);
    let res = this.post(
      "/ezdrp/zadania/zadania/powiazane/lista",
      reqData,
      params,
    );
    apiMetricWaitingTime3.add(res.timings.waiting);
  ...
  pobierzSzablonyDekretacji(param) {
    ...
    params.responseType = "none";
    let res = this.post(
      "/ezdrp/administracja/dekretacje/szablony/pobierz",
      null,
      params,
    );
