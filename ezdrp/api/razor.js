...
const generateDocWithBookmarksTime = new Trend('razor_generateDocWithBookmarksTime')
const generatePdfFromJasonModelTime = new Trend('razor_generatePdfFromJasonModelTime')
...
export class RazorTests {
  ...
  static generateConfigPDF() {
    ...
    let generateConfigPdfRes = http.post(generateConfigUrl, JSON.stringify(configPdfData), params)
  ...
  static fillDocumentTags() {
    ...
    let fillDocumentTagsRes = http.post(documentTagsUrl, JSON.stringify(documentTagsData), params)
  ...
  static generateEnvelope() {
    ...
    let generateEnvelopeRes = http.post(generateEnvelopeUrl, JSON.stringify(generateEnvelopeData), params)
  ...
  static generateLabel() {
    ...
    let generateLabelRes = http.post(generateLabelUrl, JSON.stringify(generateLabelData), params)
  ...
  static generateFromHtml() {
    ...
    let generateFromHtmlRes = http.post(generateFromHtmlUrl, JSON.stringify(generateFromHtmlData), params)
  ...
  static mergePdfDocuments() {
    ...
    let mergePdfDocumentsRes = http.post(mergePdfDocumentsUrl, JSON.stringify(mergePdfDocumentsData), params)
  ...
  static generateBarcode() {
    ...
    let generateBarcodeRes = http.post(generateBarcodeUrl, generateBarcodeData, params)
  ...
  static generateDocWithBookmarks() {
    ...
    let generateDocWithBookmarksRes = http.post(generateDocWithBookmarksUrl, JSON.stringify(generateDocWithBookmarksData), params)
    generateDocWithBookmarksTime.add(generateDocWithBookmarksRes.timings.waiting)
  ...
  static generatePdfFromJasonModel() {
    ...
    let generatePdfFromJasonModelData = {
      ...
      "Model": "ewogICAiTmFtZSI6ICJUZXN0IG5hbWUiLAogICAiTGlzdE9mSW50cyI6IFsxLCAyLCAzLCA0XQp9"
    }
    ...
    let generatePdfFromJasonModelRes = http.post(generatePdfFromJasonModelUrl, JSON.stringify(generatePdfFromJasonModelData), params)
    generatePdfFromJasonModelTime.add(generatePdfFromJasonModelRes.timings.waiting)
  ...
  static getNumberOfPdfPages() {
    ...
    let getNumberOfPdfPagesRes = http.post(getNumberOfPdfPagesUrl, pdfBianry, params)
