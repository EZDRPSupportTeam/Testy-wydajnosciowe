...
const ezdrp_metric_metadane = new Counter(
  "ezdrp_metrics_uzupelnianie_metadanych",
);
const ezdrp_metric_rejestracja_w_skladzie = new Counter(
  "ezdrp_metrics_rejestracja_w_skladzie",
);
...
class _EzdRpRejestry extends EzdRpTest {
  ...
  zarejestrujZalacznikiWSkladzie(param) {
    return this.checkBody(
      this.ezdRpApi.zarejestrujZalacznikiWSkladzie(param),
      null,
      null,
      null,
      ezdrp_metric_rejestracja_w_skladzie,
    );
  }
  dodajMetadane(param) {
    return this.checkBody(
      this.ezdRpApi.dodajMetadane(param),
      null,
      null,
      null,
