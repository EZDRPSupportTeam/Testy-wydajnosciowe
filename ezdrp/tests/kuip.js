...
class _EzdRpKuip extends EzdRpTest {
  ...
  aktualizujPodmiotAdres(param) {
    return this.checkBody(this.ezdRpApi.aktualizujPodmiotAdres(param));
  }
  pobierzZrodloFinansowania() {
    return this.checkBody(this.ezdRpApi.pobierzZrodloFinansowania());
  }
