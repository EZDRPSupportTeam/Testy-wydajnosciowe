...
class _EzdRpNoweZadania extends EzdRpTest {
  ...
  pobierzDoObsluzenia(param) {
    return this.checkBody(
      this.ezdRpApi.pobierzDoObsluzenia(param),
      null,
      null,
      null,
      ezdrp_metric1,
  ...
  dodajObieg(param) {
    return this.checkBody(
      this.ezdRpApi.dodajObieg(param),
      null,
      null,
      null,
      ezdrp_metric4,
  ...
  szczegolyPrzestrzeni(param) {
    return this.checkBody(
      this.ezdRpApi.szczegolyPrzestrzeni(param),
      null,
      null,
      null,
      ezdrp_metric2,
  ...
  pobierzAkta(param) {
    return this.checkBody(
      this.ezdRpApi.pobierzAkta(param),
      null,
      null,
      null,
      ezdrp_metric4,
  ...
  pobierzSekcje(param) {
    return this.checkBody(
      this.ezdRpApi.pobierzSekcje(param),
      null,
      null,
      null,
      ezdrp_metric4,
  ...
  pobierzObieg(param) {
    return this.checkBody(
      this.ezdRpApi.pobierzObieg(param),
      null,
      null,
      null,
      ezdrp_metric4,
  ...
  zmienNazweDokumentu(param) {
    return this.checkBody(
      this.ezdRpApi.zmienNazweDokumentu(param),
      null,
      null,
      null,
      ezdrp_metric4,
  ...
  zmienNazweDokumentuRpw(param) {
    return this.checkBody(
      this.ezdRpApi.zmienNazweDokumentuRpw(param),
      null,
      null,
      null,
      ezdrp_metric4,
  ...
  historiaPrzestrzeni(param) {
    return this.checkBody(
      this.ezdRpApi.historiaPrzestrzeni(param),
      null,
      null,
      null,
      ezdrp_metric4,
  ...
  przyjmijZadanie(param) {
    return this.checkBody(
      this.ezdRpApi.przyjmijZadanie(param),
      null,
      null,
      null,
      ezdrp_metric4,
