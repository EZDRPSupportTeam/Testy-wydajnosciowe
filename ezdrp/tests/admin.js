...
class _EzdRpAdmin extends EzdRpTest {
  ...
  pobierzOstatnioWybieraneStanowiska(param) {
    return this.checkBody(
      this.ezdRpApi.pobierzOstatnioWybieraneStanowiska(param),
    );
  }
  usunCennik(param) {
  ...
  pobierzSzablonyDokumentowFoldery(param) {
    return this.checkBody(
      this.ezdRpApi.pobierzSzablonyDokumentowFoldery(param),
    );
  }
  ...
  dodajDostepDoSzablonowDokumentow(param) {
    return this.checkBody(
      this.ezdRpApi.dodajDostepDoSzablonowDokumentow(param),
    );
  }
