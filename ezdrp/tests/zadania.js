...
class _EzdRpZadania extends EzdRpTest {
  ...
  pobierzSzczegolyZadania(idZadania) {
    return this.checkBody(
      this.ezdRpApi.pobierzSzczegolyZadania({ idZadania: idZadania }),
    );
  }
  przyjmijZadanie(idZadania) {
    return this.checkBody(
      this.ezdRpApi.przyjmijZadanie({ idZadania: idZadania }),
    );
  }
  cofnijZadanie(idZadania, opis) {
    return this.checkBody(
      this.ezdRpApi.cofnijZadanie({ idZadania: idZadania, opis: opis }),
    );
  }
  akceptujZadanie(param) {
    return this.checkBody(
      this.ezdRpApi.akceptujZadanie(param),
      null,
      null,
      null,
      ezdrp_metric_akceptacja,
    );
  }
  dokumentSprawdzCzyIstniejeNowszaWersja(param) {
    return this.checkBody(
      this.ezdRpApi.dokumentSprawdzCzyIstniejeNowszaWersja(param),
    );
  }
...
class _EzdRpZadaniaTypConst {
  ZadaniaTyp_DoAkceptacji() {
    return "2";
  }
  ZadaniaTyp_DoPodpisu() {
    return "3";
  }
  ZadaniaTyp_DoDekretacji() {
    return "4";
  }
  ZadaniaTyp_DoRealizacji() {
    return "5";
  }
}

export {
  _EzdRpZadania as EzdRpZadania,
  _EzdRpZadaniaConst as EzdRpZadaniaConst,
  _EzdRpZadaniaTypConst as EzdRpZadaniaTypConst,
};
