...
class _EzdRpKancelaria extends EzdRpTest {
    ...
    rejestrujKorespondencjeWychodzaca(param) {
        let objApiRes = this.checkBody(this.ezdRpApi.rejestrujKorespondencjeWychodzaca(param), null, null, null);
        return objApiRes;
    }
    ...
    wyslijKoperte(param) {
        let objApiRes = this.checkBody(this.ezdRpApi.wyslijKoperte(param), null, null, null);
        return objApiRes;
    }
}
