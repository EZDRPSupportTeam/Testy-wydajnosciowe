...
class _EzdRpKancelaria extends EzdRpTest {
  ...
  rejestrujPrzesylke(param) {
    let objApiRes = this.checkBody(
      this.ezdRpApi.rejestrujPrzesylkeHurtowa(param),
    );
    return objApiRes;
  }
  pobierzPismaDoRejestracjiWSkladzie(param) {
    let objApiRes = this.checkBody(
      this.ezdRpApi.pobierzPismaDoRejestracjiWSkladzie(param),
    );
    return objApiRes;
  }
  rejestrujKorespondencjeWychodzaca(param) {
    let objApiRes = this.checkBody(
      this.ezdRpApi.rejestrujKorespondencjeWychodzaca(param),
      null,
      null,
      null,
      ezdrp_metric_kw,
  ...
  pobierzSzablonyWydrukowKW(param) {
    let objApiRes = this.checkBody(
      this.ezdRpApi.pobierzSzablonyWydrukowKW(param),
    );
    return objApiRes;
  }
  ...
  zestawienieKorespondencjiWychodzacej(param) {
    let objApiRes = this.checkBody(
      this.ezdRpApi.zestawienieKorespondencjiWychodzacej(param),
    ); //, null, null, null, ezdrp_metric_kw_oznaczenie);
    return objApiRes;
  }
  wczytanieKW(param) {
  ...
  wyslijKoperte(param) {
    let objApiRes = this.checkBody(
      this.ezdRpApi.wyslijKoperte(param),
      null,
      null,
      null,
      ezdrp_metric_kw_oznaczenie,
    );
    return objApiRes;
  }
}
