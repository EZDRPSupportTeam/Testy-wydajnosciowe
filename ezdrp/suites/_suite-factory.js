...
import { EzdRpTestSuiteNoweZadania } from './nowezadania.js'
...
export class EzdRpTestSuiteFactory {
    ...
    getNoweZadania() {
        return this.prepareTestSuite(new EzdRpTestSuiteNoweZadania());        
    }
    ...
    getNoweZadaniaTests() {
        return new EzdRpNoweZadania(this._ezdRpClient);
    }
}