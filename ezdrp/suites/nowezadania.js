...
export class EzdRpTestSuiteNoweZadania extends EzdRpTestSuite {
  pobierzDoObsluzenia() {
    ...
    ezdRpDashoard.pobierzPraweMenu(
      "ZADANIA_DO_OBSLUZENIA",
      null,
      "nowe-zadania.dodaj-obieg",
    );
  ...
  szczegolyPrzestrzeni(param) {
    ...
    let sekcje = ezdRpNoweZadania.pobierzSekcje({
      idPrzestrzenRobocza: szczegoly.idPrzestrzenRobocza,
    });
