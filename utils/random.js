...
/**
 * Nowa funkcja losująca z parametrem prawdopodobieństwa
 * @param callbackTrue - funkcja wywoływana gdy true
 * @param callbackFalse - funkcja wywoływana gdy false
 * @param probability - prawdopodobieństwo (0-100), domyślnie 50
 * @returns boolean - czy wykonano callbackTrue
 */
export function randomByProbability(
  callbackTrue,
  callbackFalse,
  probability = 50,
) {
  if (probability < 0 || probability > 100) {
    console.log(`Błędne prawdopodobieństwo: ${probability}. Ustawiam na 50%`);
    probability = 50;
  }

  let randVal = Math.random() * 100 < probability;
