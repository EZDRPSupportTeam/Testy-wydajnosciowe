...
class _FileLoader {
    static readAndAddFile() {
        ...
        for (let i = 0; i < FILES.length; i++) {
            ...
            let fileContentType = key.endsWith('msg') ? "application/vnd.ms-outlook" : key.endsWith('pdf') ? 'application/pdf' : 'application/vnd.openxmlformats-officedocument.wordprocessingml.document';
