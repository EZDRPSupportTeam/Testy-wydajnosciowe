              ...
              function (e, r, t) {
                ...
                function f(e, r) {
                  ...
                  if (e.cache) {
                    ...
                    a || (r = v(i).toString().replace(u, ""));
                  } else if (!a) {
                    if (!i)
                      throw new Error(
                        "Internal EJS error: no file name or template provided",
                      );
                    r = v(i).toString().replace(u, "");
                  }
                  return (
                    (n = t.compile(r, e)),
                    e.cache && t.cache.set(i, n),
                    n
                  );
                }
                function m(e, r, n) {
                ...
                function g(e, r) {
                  var i = a.shallowCopy(a.createNullProtoObjWherePossible(), r);
                  if (
                    ((i.filename = (function (e, r) {
                      ...
                      if (o && o.length)
                        ((e = e.replace(/^\/*/, "")),
                          (i = Array.isArray(r.root)
                            ? p(e, r.root)
                            : t.resolveInclude(e, r.root || "/", !0)));
                      else if (
                        (r.filename &&
                          ((a = t.resolveInclude(e, r.filename)),
                          n.existsSync(a) && (i = a)),
                        !i && Array.isArray(s) && (i = p(e, s)),
                    ...
                    if (
                      s &&
                      (s.filename && (i.filename = s.filename), s.template)
                    )
                      return f(i, s.template);
                  }
                  return f(i);
                }
                ...
                function x(e, r) {
                  r = r || a.createNullProtoObjWherePossible();
                  var n = a.createNullProtoObjWherePossible();
                  ((this.templateText = e),
                    (this.mode = null),
                    (this.truncate = !1),
                    (this.currentLine = 1),
                    ...
                    (n.client = r.client || !1),
                    (n.escapeFunction =
                      r.escape || r.escapeFunction || a.escapeXML),
                    (n.compileDebug = !1 !== r.compileDebug),
                    (n.debug = !!r.debug),
                    (n.filename = r.filename),
                    (n.openDelimiter =
                      r.openDelimiter || t.openDelimiter || "<"),
                    (n.closeDelimiter =
                      r.closeDelimiter || t.closeDelimiter || ">"),
                    ...
                    (n.legacyInclude =
                      void 0 === r.legacyInclude || !!r.legacyInclude),
                    n.strict
                      ? (n._with = !1)
                      : (n._with = void 0 === r._with || r._with),
                    (this.opts = n),
                ...
                ((t.cache = a.cache),
                  ...
                  (t.render = function (e, r, t) {
                    var n = r || a.createNullProtoObjWherePossible(),
                      i = t || a.createNullProtoObjWherePossible();
                    return (
                      2 == arguments.length && a.shallowCopyFromList(i, n, d),
                      f(i, e)(n)
                    );
                  }),
                  (t.renderFile = function () {
                    ...
                    return (
                      ...
                      n.length
                        ? ((r = n.shift()),
                          n.length
                            ? a.shallowCopy(s, n.pop())
                            : (r.settings &&
                                (r.settings.views &&
                                  (s.views = r.settings.views),
                                r.settings["view cache"] && (s.cache = !0),
                                (t = r.settings["view options"]) &&
                                  a.shallowCopy(s, t)),
                              a.shallowCopyFromList(s, r, l)),
                          (s.filename = i))
                        : (r = a.createNullProtoObjWherePossible()),
                      m(s, r, e)
                    );
                  }),
                  (t.Template = x),
                  ...
                  (x.prototype = {
                    createRegex: function () {
                      var e = "(<%%|%%>|<%=|<%-|<%_|<%#|<%|%>|-%>|_%>)",
                        r = a.escapeRegExpChars(this.opts.delimiter),
                        t = a.escapeRegExpChars(this.opts.openDelimiter),
                        n = a.escapeRegExpChars(this.opts.closeDelimiter);
                      return (
                        (e = e
                          .replace(/%/g, r)
                          .replace(/</g, t)
                    ...
                    compile: function () {
                      ...
                      if (!this.source) {
                        if (
                          ...
                          if (!h.test(n.outputFunctionName))
                            throw new Error(
                              "outputFunctionName is not a valid JS identifier.",
                            );
                          s +=
                            "  var " + n.outputFunctionName + " = __append;\n";
                        }
                        if (n.localsName && !h.test(n.localsName))
                          throw new Error(
                            "localsName is not a valid JS identifier.",
                          );
                        if (
                          n.destructuredLocals &&
                          n.destructuredLocals.length
                        ) {
                          for (
                            var l =
                                "  var __locals = (" +
                                ...
                                " || {}),\n",
                              u = 0;
                            u < n.destructuredLocals.length;
                            u++
                          ) {
                            var p = n.destructuredLocals[u];
                            if (!h.test(p))
                              throw new Error(
                                "destructuredLocals[" +
                                  u +
                      ...
                      try {
                        ...
                        r = new t(
                          n.localsName + ", escapeFn, include, rethrow",
                          e,
                        );
                      } catch (e) {
                        throw (
                      ...
                      var f = n.client
                        ...
                        : function (e) {
                            return r.apply(n.context, [
                              e || a.createNullProtoObjWherePossible(),
                              c,
                              function (r, t) {
                                var i = a.shallowCopy(
                                  a.createNullProtoObjWherePossible(),
                                  e,
                                );
                                return (
                                  t && (i = a.shallowCopy(i, t)),
                                  g(r, n)(i)
                                );
                              },
                              b,
                    ...
                    parseTemplateText: function () {
                      for (
                        ...
                        (0 !== (e = n.index) &&
                          (i.push(r.substring(0, e)), (r = r.slice(e))),
                          i.push(n[0]),
                        ...
                        default:
                          if (this.mode) {
                            ...
                            switch (this.mode) {
                              ...
                              case x.modes.ESCAPED:
                                this.source +=
                                  "    ; __append(escapeFn(" + _(e) + "))\n";
                                break;
                              case x.modes.RAW:
                                this.source += "    ; __append(" + _(e) + ")\n";
                                break;
            ...
            2: [
              function (e, r, t) {
                ...
                ((t.escapeXML = function (e) {
                  return null == e ? "" : String(e).replace(o, c);
                }),
                ...
                (function (e) {
                  ...
                  ((t.resolve = function () {
                    ...
                    (t.relative = function (e, r) {
                      ...
                      var d = [];
                      for (c = o; c < i.length; c++) d.push("..");
                      return (d = d.concat(a.slice(o))).join("/");
                    }),
                    (t.sep = "/"),
                    (t.delimiter = ":"),
                ...
                ((a.nextTick = function (e) {
                  ...
                  if (arguments.length > 1)
                    for (var t = 1; t < arguments.length; t++)
                      r[t - 1] = arguments[t];
                  (l.push(new m(e, r)), 1 !== l.length || u || c(f));
                }),
